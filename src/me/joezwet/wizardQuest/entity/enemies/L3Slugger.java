...
public class L3Slugger extends Enemy {
	
	private BufferedImage[] sprites;
	
	public L3Slugger(TileMap tm) {
		super(tm);
		...
		//spirte
		try {
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/l3slugger.gif"));
