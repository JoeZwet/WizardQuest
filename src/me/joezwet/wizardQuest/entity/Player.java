...
import me.joezwet.wizardQuest.audio.AudioPlayer;
...
public class Player extends MapObject {
	...
	private final int[] numFrames = { 1, 2, 1, 1, 2, 2, 5 };
	...
	public Player(TileMap tm) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Player/player.gif"));
